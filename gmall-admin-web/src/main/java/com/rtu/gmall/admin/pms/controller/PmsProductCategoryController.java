...
public class PmsProductCategoryController {
    ...
    public Object listWithChildren() {
        List<PmsProductCategoryWithChildrenItem> categories = productCategoryService.listCategoryWithChildren(0);
